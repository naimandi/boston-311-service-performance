...
### Purpose 
This project analyzes Boston 311 service request data to visualize key aspects of service performance, including case volume trends, resolution times, SLA compliance, department-level performance, etc. Interactive dashboards created in Tableau allow exploration of both time-based trends and overall service patterns.
